...
let ec_tome_data = '{"eccentrictome:mods":{apotheosis:{0:{Count:1b,id:"patchouli:guide_book",tag:{"patchouli:book":"apotheosis:apoth_chronicle"}}},bloodmagic:{0:{Count:1b,id:"patchouli:guide_book",tag:{"patchouli:book":"bloodmagic:guide"}}},buildinggadgets2:{0:{Count:1b,id:"patchouli:guide_book",tag:{"patchouli:book":"buildinggadgets2:buildinggadgets2book"}}},computercraft:{0:{Count:1b,id:"computercraft:computer_craft_manual"}},create:{0:{Count:1b,id:"create:create_manual"}},pneumaticcraft:{0:{Count:1b,id:"patchouli:guide_book",tag:{"patchouli:book":"pneumaticcraft:book"}}},productivebees:{0:{Count:1b,id:"patchouli:guide_book",tag:{"patchouli:book":"productivebees:guide"}}},securitycraft:{0:{Count:1b,id:"securitycraft:sc_manual"}}},modularforcefields:{0:{Count:1b,id:"patchouli:guide_book",tag:{"patchouli:book":"mffs:handbook"}}},playercompanions:{0:{Count:1b,id:"patchouli:guide_book",tag:{"patchouli:book":"player_companions:guide"}}},industrialforegoing:{0:{Count:1b,id:"patchouli:guide_book",tag:{"industrialforegoing:industrial_foregoing"}}},appliedcooking:{0:{Count:1b,id:"patchouli:guide_book",tag:{"sebastrnlib:sebastrn_mods_guide_book"}}}}'
