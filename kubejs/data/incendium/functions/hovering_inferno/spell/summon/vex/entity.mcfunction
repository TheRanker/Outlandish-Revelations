...
summon minecraft:vex ~ ~1 ~ {Tags:["in.inferno_entity", "in.minion"],LifeTicks:500,CustomName:'{"translate":"incendium.mob.inferno.minion.name","fallback":"Infernal Minion"}',HandItems:[{id:"netherite_sword",Count:1}],HandDropChances:[-327.0f]}
